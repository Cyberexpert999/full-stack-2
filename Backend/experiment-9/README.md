...
![Server Running](screnshorts/1.png)
Render development server successfully started.

### 2. Basic Protected (GET)

![basic Protected](screnshorts/2.png)

Logging in using basic authorization

### 3. Token Login (POST)

![Token Login](screnshorts/3.png)

### Token Protected(GET)

![Token Protected](screnshorts/4.png)

### 4. JWT Login

![Read All Students](screnshorts/5.png)

### 5. JWT Token Verification

### Using Bearer Token

![Read One - ID 1](screnshorts/6.png)
